...
import com.bakery.api.framework.dtos.*;
...
public abstract class AdminBaseResource<REQ, RES extends BakeryBaseResponse, E extends BaseAdminEntity, FILTER extends AdminFilter> {
    ...
    @GetMapping("/meta")
    @Operation(summary = "Metadata: field capabilities, filter operators, search fields")
    public ResponseEntity<EntityMeta> getMeta() {
        EntityMeta meta = abstractSupport().getMeta();
